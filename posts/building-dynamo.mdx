...
Hey! Alex here. This article is a deep dive into my recent project for Dynamo Ventures. We'll start with a general overview, and then go further into what made this build really unique. If you want to check out the finished site while you read, you can do so here: <Link href="https://dynamo.vc/" target="_blank" rel="noopener noreferrer">dynamo.vc</Link>

## Project Overview

Dynamo Ventures is a US-based venture capital firm focused on backing relentless founders challenging how our industrial economy operates at the pre-seed and seed stage (provided by client 😉). In early 2025, they were nearing the <Link href="https://dynamo.vc/insights-and-news/dynamo-ventures-closes-54m-fund-iii-unlocks-liquidity-for-early-lps-with-top-decile-returns" target="_blank" rel="noopener noreferrer">close of their latest fund</Link>, and faced a common issue: their website wasn't keeping pace with the growth of their business.

Their existing site, built on <Link href="https://super.so/" target="_blank" rel="noopener noreferrer">Super.so</Link> and <Link href="https://www.notion.com/" target="_blank" rel="noopener noreferrer">Notion</Link>, worked well in the beginning, but as Dynamo grew as a firm, the platform's design and functional constraints became... constraining. They needed a site that could scale with them, supporting better content presentation, rich thought leadership, and professional design standards. The challenge was preserving the simple workflows their team had grown accustomed to with Notion.

TLDR; They needed something more sophisticated, yet still easy to manage.
...
The result was a polished system that captured Dynamo's evolution as a company and brand.
...
With that now in place, I stepped in to solve the technical challenge: how do you transform a custom design into a website that's as easy to manage as Notion?
...
## Ready to Scale Beyond Templates?

If your company has outgrown basic website builders but you want to maintain the simplicity your team loves, I can help. Whether you're a growing VC firm, B2B company, or digital-first organization, I specialize in building custom platforms that feel as intuitive as Notion but perform like enterprise software.

**What I bring to the table:**
- **Custom digital platforms** built with modern tech stacks (PayloadCMS, Next.js, React)
- **Seamless content migration** from existing systems without losing data or design
- **Team-friendly admin experiences** that require zero technical knowledge
- **Performance-first development** optimized for speed, SEO, and user experience

The Dynamo project took 3 months from design to launch. Most similar platforms require 2-4 months depending on complexity and content volume.

**Ready to discuss your project?** Reach out at hello@alex.cn.com with a brief overview of your current setup and what you're hoping to achieve. I'll respond with thoughts on approach, timeline, and next steps.
